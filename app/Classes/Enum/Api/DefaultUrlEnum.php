...
{
    // аватар пользователя
    const USER_DEFAULT_AVATAR_URL = 'http://department.biz/storage/avatars/users/default.jpg';
    ...
    const DISCIPLINE_DEFAULT_BACKGROUND_URL = 'http://department.biz/storage/backgrounds/disciplines/default.jpg';
}
